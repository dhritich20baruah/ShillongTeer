...
const GameCode = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center text-black w-full">
      ...
      <p className="text-xl font-semibold m-2 text-white shadow-black shadow-lg bg-black p-3 opacity-90">DATE: {formatted_date}</p>
      <div className='m-5 w-full flex items-center justify-center bg-white'>
        <p className='py-32 text-5xl font-bold text-black'>{gameCode}</p>
      </div>
    </div>
  )
}
